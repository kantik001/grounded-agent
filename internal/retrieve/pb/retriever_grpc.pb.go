...
const (
	Retriever_Retrieve_FullMethodName = "/grounded.rag.v1.Retriever/Retrieve"
)
...
func RegisterRetrieverServer(s grpc.ServiceRegistrar, srv RetrieverServer) {
	// If the following call panics, it indicates UnimplementedRetrieverServer was
...
var Retriever_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grounded.rag.v1.Retriever",
